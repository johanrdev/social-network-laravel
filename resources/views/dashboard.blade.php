                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <ul>
                        <li class="flex border-b last:border-b-0 hover:bg-teal-100 transition-colors duration-250 flex items-center hover:pl-2 transition-all duration-150">
                            ...
                            <a href="{{ route('dashboard') }}?tab=blogs" class="grow p-1">Blogs</a>
                        </li>
                        <li class="flex border-b last:border-b-0 hover:bg-teal-100 transition-colors duration-250 flex items-center hover:pl-2 transition-all duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                            ...
                            <a href="{{ route('dashboard') }}?tab=posts" class="grow p-1">Posts</a>
                        </li>
                        <li class="flex border-b last:border-b-0 hover:bg-teal-100 transition-colors duration-250 flex items-center hover:pl-2 transition-all duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                            ...
                            <a href="{{ route('dashboard') }}?tab=categories" class="grow p-1">Categories</a>
                        </li>
                        <li class="flex border-b last:border-b-0 hover:bg-teal-100 transition-colors duration-250 flex items-center hover:pl-2 transition-all duration-150">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1">
                            ...
                            <a href="{{ route('dashboard') }}?tab=comments" class="grow p-1">Comments</a>
                        </li>
                    </ul>
                </div>
            </div>
